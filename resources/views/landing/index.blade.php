                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="row g-3 mt-4">
                            <div class="col-md-6">
                                <a href="{{ route('bengkels.grid') }}" class="btn btn-light btn-lg w-100">
                                    <i class="isax isax-location me-2"></i>
                                    Lihat Semua Bengkel
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('bengkels.grid', ['verified' => 1]) }}" class="btn btn-light btn-lg w-100">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <p class="text-white mb-0 fs-3">Dapatkan bantuan sekarang juga dari bengkel terdekat dan terpercaya</p>
                </div>
