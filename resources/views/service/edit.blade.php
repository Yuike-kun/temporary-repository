                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('service.update', $service) }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Servis</label>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="isax isax-tick-circle"></i> Update
                                </button>
                                <a href="{{ route('service.index') }}" class="btn btn-secondary">
                                    <i class="isax isax-close-circle"></i> Batal
                                </a>
                            </div>
                        </form>
                    </div>
